const projects = [
    {
        ...
        desc: `
            This site uses Node.js with Express.js and an API from newsapi.org.  The API delivers the top 10 news stories from theVerge.com.  My reasons for 
            making this were to gain experience using APIs with Node, and to make something that was stylish, modern, and responsive for use on mobile devices.
